...
# If there is not profit that could have been made with the stock prices, then your 
# program should return -1. For example: arr is [10, 9, 8, 2] then your program should return -1. 
