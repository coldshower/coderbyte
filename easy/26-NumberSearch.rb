...
# should be 91. You will have to differentiate between single digit numbers and multiple digit numbers like 
...
def NumberAddition(str)
  str.downcase.split(/[^0-9]+/).reduce(0) {|result, elem| result + elem.to_i}
end